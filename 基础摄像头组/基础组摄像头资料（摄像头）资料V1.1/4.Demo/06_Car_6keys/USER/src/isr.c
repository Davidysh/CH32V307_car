...
void EXTI3_IRQHandler(void)
{
    if(SET == EXTI_GetITStatus(EXTI_Line3))
    {
        ...
        car_both_rgb_on(green);   //按下按键4，尾灯显示绿色
        ips114_show_string(0, 0, "key4");
        board_led_toggle(1);
    }
}
...
void EXTI4_IRQHandler(void)
{
    if(SET == EXTI_GetITStatus(EXTI_Line4))
    {
        ...
        car_both_rgb_on(white);   //按下按键5，尾灯显示白色
        ips114_show_string(0, 0, "key5");
    }
}
...
void EXTI9_5_IRQHandler(void)
{
    if(SET == EXTI_GetITStatus(EXTI_Line5))
    {
        ...
        car_both_rgb_off();       //按下按键6，尾灯熄灭
        ips114_show_string(0, 0, "key6");
...
void EXTI15_10_IRQHandler(void)
{
    if(SET == EXTI_GetITStatus(EXTI_Line10))
    {
        ...
        while(gpio_get_input(D10) == 0);
        ips114_show_string(0, 20, "reed :");
        reed_num++;
        ips114_show_int(40, 20, reed_num, 3);
